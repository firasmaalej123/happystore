...
<a href="profile.php" class="accordion-menu" data-accordion-btn>
  ...
  <div class="container">
  <a href="generate.php?param=women shorts" class="button">
    <i class="fas fa-male"></i> Shorts & Jeans
</a>
<a href="generate.php?param=women shirts" class="button">
    <i class="fas fa-tshirt"></i> Shirts & Jackets
</a>
<a href="generate.php?param=women dresses" class="button">
    <i class="fas fa-female"></i> Dresses
</a>
<a href="generate.php?param=women shoes" class="button">
